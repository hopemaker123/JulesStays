            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground mb-6">
                        At Jules Stays, we are dedicated to providing an experience that transcends the ordinary. From our meticulously designed interiors to our personalized services, every detail is crafted to ensure your stay is nothing short of perfect. Let us be your home away from home.
                    </p>
